    ...
    return (
        <footer id="social-links">
            <div className="social-icons">
                ...
                <div className="contact-item">
                    <a className="icon-button" href="https://linkedin.com/JQ" target="_blank" rel="noopener noreferrer">
                ...
                <div className="contact-item">
                    <a className="icon-button" href="https://whatsapp.com" target="_blank" rel="noopener noreferrer">
